...
const NAV_ITEMS = [
  ...
  { href: "/sunum", label: "Proje Sunumu", icon: PresentationIcon, external: true },
];
            ...
            if (item.external) {
              return (
                <a
                  ...
                  className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-white/5"
                >
...
function PresentationIcon({ active }) {
  return (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke={active ? "#a78bfa" : "currentColor"} strokeWidth={1.5}>
